...
with col1:
    ...
    channel_id=['UCqwUrj10mAEsqezcItqvwEw', # BB ki Vines
                'UCbmu9wfzxKls40WkCzvqtRA', # Elvish Yadav
    ...
    if Get_data or st.session_state.Get_state:
        ...
        upload = collection.insert_one({'_id': channel_id}, final_output)
...
connect_for_question = pymysql.connect(host='localhost', user='root', password='aditya1234', db='youtube_db')
